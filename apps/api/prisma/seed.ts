import { PrismaClient, UserRole, LeadStatus, LeadSource, DialerIntegrationType, CallPurpose, CallDirection, CallStatus, ComplianceState, ScriptCategory, ScopeOfAppointmentChannel, ScopeOfAppointmentSignatureMethod, ScopeOfAppointmentStatus, EnrollmentStatus, EnrollmentVerificationMethod, EnrollmentVerificationOutcome, TaskType, TaskStatus, TaskPriority } from '@prisma/client';
